...
export function IconTest(props) {
  ...
  return (
    ...
    >
      <path
        d="M517.2,558.4c0-7.4-5.1-12.6-12.5-12.6h-37.1v-55.1c0-7.4-5.1-12.5-12.5-12.5s-12.5,5.1-12.5,12.5v79.9h64.6
	...
	H145.9c-31.5,0-55.5,25.1-55.5,57.3v359.4C90.4,638.2,114.5,663,145.9,663L145.9,663z"
      ...
      <path d="M134.3,663" />
      <path
        d="M455.1,663c64.6,0,116.5-52.5,116.5-117.2c0-64.8-52.1-117.2-116.5-117.2c-64.3,0-116.5,52.5-116.5,117.2
	...
	c-49.6,0-91.8-39.9-91.8-92.4C363.3,495.9,405.6,453.4,455.1,453.4L455.1,453.4z"
      />
      <path
        d="M167.7,320.5h227c7.2,0,12.1-5.1,12.1-12.6c0-7.4-5-12.5-12.1-12.5h-227c-7.2,0-12.2,5.1-12.2,12.5
	C155.6,315.3,160.3,320.5,167.7,320.5L167.7,320.5z"
      />
      <path
        d="M285.2,467.7H166.6c-6.5,0-11.1,5.1-11.1,12.5s4.5,12.6,11.1,12.6h118.5c6.5,0,11-5.1,11-12.6
	C296.2,472.8,291.9,467.7,285.2,467.7L285.2,467.7z"
      />
      <path
        d="M348.2,382.6H165.3c-5.8,0-9.8,5.1-9.8,12.6c0,7.4,4,12.6,9.8,12.6h182.9c5.8,0,9.8-5.1,9.8-12.6
