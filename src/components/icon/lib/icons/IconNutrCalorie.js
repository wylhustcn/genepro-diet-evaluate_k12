...
export function IconNutrCalorie(props) {
  ...
  return (
    ...
    >
      <path
        id="XMLID_121_"
        d="M74.3,160.9v142.5c0,6.3-3.7,11.6-8.2,11.6c-4.4,0-8.1-5.3-8.1-11.6V151.8c-2.6-0.7-5.3-1-8-1
	...
	c0-0.4-0.1-1-0.1-1.3c16.7-9.8,28.5-33.4,28.5-61.3v-77.8C95.3,193.1,86.9,172.8,74.3,160.9z"
      ...
      <path
        id="XMLID_120_"
        d="M602.2,423.1l0.1,0.2l-1.1-273.4c-20.6-1.2-37.7,27.8-38.3,64.8l-7.6,119.2
	c-0.4,28.3,6.9,50.4,17.2,63.6l-6.2,182.6c0,20.2,9.2,36.8,20.5,36.8c11.3,0,20.5-16.6,20.5-36.8L602.2,423.1z"
      />
      <path
        id="XMLID_308_"
        d="M321.3,184.2c-126.4,0-228.9,102.6-228.9,229.1c0,126.4,102.5,228.8,228.9,228.8
	...
	c0-96.3,78.1-174.4,174.2-174.4c96,0,174.1,78.1,174.1,174.4C495.5,509.2,417.3,587.3,321.3,587.3z"
      ...
      <g id="XMLID_300_">
        <polygon
          id="XMLID_109_"
          points="241.4,457.7 224,420.3 210.9,435.9 210.9,457.7 185.4,457.7 185.4,367 210.9,367
		210.9,401.4 237.5,367 271.4,367 241.4,401.1 272.8,457.7 	"
        />
        <path
          id="XMLID_107_"
          d="M340.2,447.6c-2.8,3.8-6.2,6.7-10.5,8.6c-4.3,2-9.7,3.2-16.3,3.2c-6.3,0-11.6-0.7-15.8-1.9
        ...
        <path
          id="XMLID_302_"
          d="M387.4,430c3.4-1,6.8-2.2,9.8-3.5v4.3c0,2.9-0.5,5.6-1.3,7.6c-1,1.9-2.5,3.4-4.7,4.8
        ...
        />
        <rect id="XMLID_104_" x="434.3" y="367" width="22.9" height="90.7" />
      </g>
    </svg>
  );
}

IconNutrCalorie.defaultProps = {
  color: "currentColor",
  size: 24
};

IconNutrCalorie.propTypes = {
