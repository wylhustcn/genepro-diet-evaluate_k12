...
export function IconNutrCarbohydrate(props) {
  const { size, color, ...other } = props;
  return (
    <svg
      version="1.1"
      id="svg-nutr-carbohydrate"
      x="0px"
      y="0px"
      viewBox="0 0 612 792"
      height={size}
    ...
    >
      <g>
        ...
        <g>
          <defs>
            <rect
              id="svg-nutr-carbohydrate@SVGID_1_"
              x="-40"
              y="99"
              width="691.9"
              height="595.9"
          ...
          <path
            ...
            clipPath="url(#svg-nutr-carbohydrate@SVGID_1_)"
          />
          <path
...
IconNutrCarbohydrate.defaultProps = {
  color: "currentColor",
  size: 24
};

IconNutrCarbohydrate.propTypes = {
